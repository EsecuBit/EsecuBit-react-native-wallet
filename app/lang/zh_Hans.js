export default {
  ...
  showEOSAccountTip: '温馨提示： 请核对下面的账户与设备上的账户是否匹配',
  ...
  invalid: 'Invalid',
  confirming: '确认中',
  checkAppVersion: '检查App更新',
  checkAppletVersion: '检查Applet更新',
  versionUpdate: '版本更新',
  ...
  delegate: "抵押",
  undelegate: '赎回',
  eosAccountNotRegister: '账户还未注册，请先去注册,若已注册，请刷新当前账户',
  register: '注册',
  receiver: '接收者',
  status: '状态',
  executed: '不可逆',
  ...
  date: '时间',
  amount: '数量',
  byInEosOrBytes: '以 EOS 或 Bytes（字节）作为计量单位',
  blockProducers: '节点',
  proxy: '代理',
  all: '全部',
  transfer: '转账',
  ...
  importMultipleKeyError: '请一次导入一个私钥',
  pinIsLocked: 'Pin码已被锁',
  upgrade: '升级',
  get_script: '获取脚本中...',
  handle_data: '处理数据中...',
